...
const navigation = [
  {
    title: 'Dockerとは',
    links: [
      { title: '概要、インストール', href: '/docs/docker' },
    ],
  },
  {
    title: 'Docker 1',
    links: [
      { title: 'Image、Container', href: '/docs/docker/basic-1' },
    ],
  },
  {
    title: 'Docker 2',
    links: [
      { title: 'Volums　🏃作成中', href: '#' },
      { title: 'Network　🏃作成中', href: '#' },
    ],
  },
  {
    title: 'Docker Compose 1',
    links: [
      { title: 'Webサイト1　🏃作成中', href: '#' },
      { title: 'Webサイト2　🏃作成中', href: '#' },
    ],
  },
  {
    title: 'Docker Compose 2',
    links: [
      { title: 'Webシステム　🏃作成中', href: '#' },
    ],
  },
...
export function LayoutDocker({ children, title, tableOfContents }) {
      ...
      <div className="relative mx-auto flex max-w-8xl justify-center sm:px-2 lg:px-8 xl:px-12">
        <div className="hidden lg:relative lg:block lg:flex-none">
          ...
          <div className="sticky top-[4.5rem] -ml-0.5 h-[calc(100vh-4.5rem)] overflow-y-auto overflow-x-hidden py-8 pl-0.5" >
            ...
            <div className="underline decoration-double mb-4 font-medium text-slate-500 decoration-slate-500">Docker コース</div>
