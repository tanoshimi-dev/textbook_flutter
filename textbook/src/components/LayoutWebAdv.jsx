...
const navigation = [
  {
    title: 'JS ライブラリ',
    links: [
      { title: 'jQuery', href: '/docs/webdev1-html' },
    ],
  },
...

  {
    title: 'データベース',
    links: [
      { title: 'MySQL', href: '/docs/webdev1-html' },
      {
        title: 'MongoDB',
        href: '/docs/predicting-user-behavior',
      },
...

  {
    title: 'Security',
    links: [
      { title: 'JWT', href: '/docs/webdev1-html' },
      { title: 'OAuth', href: '/docs/webdev1-html' },
    ],
  },
...
export function LayoutWebAdv({ children, title, tableOfContents }) {
      ...
      <div className="relative mx-auto flex max-w-8xl justify-center sm:px-2 lg:px-8 xl:px-12">
        <div className="hidden lg:relative lg:block lg:flex-none">
          ...
          <div className="sticky top-[4.5rem] -ml-0.5 h-[calc(100vh-4.5rem)] overflow-y-auto overflow-x-hidden py-8 pl-0.5" >
            ...
            <div className="underline decoration-double mb-4 font-medium text-slate-500 decoration-slate-500">Web応用コース</div>
